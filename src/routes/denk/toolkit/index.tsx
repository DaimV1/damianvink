...
const DESCRIPTION =
  "Engineering toolkit: ISO 286-passingen, DIN 6885-spiebanen, SKF-lagerpassingen, seegerringgroef DIN 471/472, VDI 2230-bevestigingsmateriaal, ISO 2768 algemene toleranties, motorspecificatie, richtlijnen kanten, O-ringgroef ISO 3601 en CAD-bronnen. Rekenhulp bovenaan, naslag eronder.";
...
function ToolkitIndex() {
  return (
    <ToolkitFrame
      ...
      before="Engineering"
      last="toolkit."
      lede="Rekenhulp en naslag voor machinebouw: passingen, spiebanen, lagers, seegerringgroeven, bevestigingsmateriaal, algemene toleranties, motorspecificatie, richtlijnen kanten en CAD-bronnen. Open een tool; de rekenhulp staat bovenaan, de tabel of bronnen eronder."
    >
      <JsonLd
        data={softwareJsonLd({
