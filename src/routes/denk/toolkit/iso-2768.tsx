    ...
    >
      ...
      <Faq
        items={[
          ...
          {
            q: "Wanneer de afwijking naast de maat zetten?",
            a: "Onder 0,5 mm heeft ISO 2768 geen rij. De afwijking moet naast de maat op de tekening. Deze rekenhulp verzint geen naburige waarde.",
          },
          {
